...
// o segundo argumento vai ser a quantidade deletada
frutas.splice(3, 3);
console.log(frutas);

// join - coloca separadores entre os elementos
...
// sort
var numerosDois = [7, 9, 2, 5, 1];
console.log(numerosDois.sort());
...
// devolve a posição do último achado, se não existir
// devolve o -1
